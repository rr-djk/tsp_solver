 ...
 * @param opts   Options CLI utilisées pour produire ce résultat (section config).
 ...
 *
 * Structure JSON : config (algo, threads, repeat, all_start, time_limit_s),
 *                  status, file_name, algo_name, cost, time_ms,
